...
namespace GE.Presentacion.GymEvolution.Controllers
{
    ...
    [ApiController]
    public class ClientesControllerApi : ControllerBase
    {
        private readonly Context _context;

        public ClientesControllerApi(Context context)
        {
            _context = context;
        }

        // GET: api/ClientesControllerApi
        [HttpGet]
        ...
        // GET: api/ClientesControllerApi/5
        [HttpGet("{id}")]
        ...
        // PUT: api/ClientesControllerApi/5
        [HttpPut("{id}")]
        ...
        // POST: api/ClientesControllerApi
        [HttpPost]
        ...
        // DELETE: api/ClientesControllerApi/5
        [HttpDelete("{id}")]
